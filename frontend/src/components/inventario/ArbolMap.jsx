...
const ArbolMap = ({ arboles = [], especies = [], selectedArbol, onSelect }) => {
  const [capaActiva, setCapaActiva] = useState('callejero')
  const [mapCenter, setMapCenter] = useState([1.0878, -76.6314]) // Mocoa, Putumayo
  ...
  if (puntos.length === 0) {
    return (
      <div className="card text-center py-12">
        <p className="text-gray-500">No hay árboles con coordenadas para mostrar</p>
      </div>
    )
  }
